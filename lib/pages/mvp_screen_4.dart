...
class MvpScreen4 extends StatelessWidget {
  const MvpScreen4({super.key});
    ...
    return Container(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Container(
              margin: EdgeInsets.fromLTRB(26.6, 0, 26.6, 43),
              child: Align(
            ...
            Container(
              margin: EdgeInsets.fromLTRB(18, 0, 18, 86),
              child: Align(
            ...
            Container(
              ...
              child: Align(
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      margin: EdgeInsets.fromLTRB(3.2, 0, 9.2, 56),
                      child: SizedBox(
                        width: 276,
                        height: 244,
                        child: SvgPicture.asset(
                          'assets/vectors/learningcuate_x2.svg',
                        ),
                      ),
                    ),
                    Column(
                      ...
                      children: [
                        Container(
                          margin: EdgeInsets.fromLTRB(8.9, 0, 8.9, 36),
                          child: Text(
                        ...
                        Text(
                          'Learn budgeting, saving, debt management and investing through clear, interactive resources tailored to your personal financial needs.',
